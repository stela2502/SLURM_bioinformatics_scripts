...
$task_description .= 'perl '.$plugin_path .'/backupPath.pl';
...
## simply use the linux cp -R command!
print "cp -R $path/* $outpath\n";
system( "cp -R $path/* $outpath" );

print "files copied to the backup folder.\n";
